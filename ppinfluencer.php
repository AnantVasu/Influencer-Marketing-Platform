...
/*
$q = " select yname from influencersignup where yname = '$yname' ";
$result=mysqli_query($con,$q);

$row=mysqli_fetch_assoc($result);
		echo "<br><font size = 7>$row</font>";
*/
...
<aside>
<div class="pp">
	<!-- <img src="influence.jpg" alt="Logo" width="250" height="250">
	<h5>
...
<div class="abs">
<div >
	<h2 class="subheadline">Explore Campaigns</h2>
</div>
...
<iframe src="demo_iframe.php" height="400" width="1300" ></iframe>
</div>
</div>
	<!--<div class="headline">
		Sign In
